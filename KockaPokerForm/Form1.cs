...
namespace KockaPokerForm
{
    public partial class frmFo : Form
    {
        ...
        private void btnDobas_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Gép nyert!", "Játszott kör", MessageBoxButtons.OK,
            ...
            {
                MessageBox.Show("Ember nyert!", "Játszott kör", MessageBoxButtons.OK,
                    MessageBoxIcon.Information);
                ember.Nyert++;
            ...
            {
                MessageBox.Show("Döntetlen!", "Játszott kör", MessageBoxButtons.OK,
                    MessageBoxIcon.Information);
            }
        }
    }
